...
public class RegisterSteps extends BaseCommonMethodsClass {
    ...
    public static String patientName="Jay Pascal";
    ...
    public void user_fills_his_information() throws InterruptedException {
        ...
        registerPage.patientEmail.sendKeys("JayP@gmail.com");
        registerPage.patientPhoneNumber.sendKeys("332-598-4523");
        registerPage.calendarBtn.click();
        Thread.sleep(2000);
        driver.findElement(By.id("patient-dob")).sendKeys("08181990");
        registerPage.patientAddress.sendKeys("913 Brooklyn St,apt 4 New york, New York, 11102");
    }
